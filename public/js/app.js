            ...
            <div class="uc-section" style="margin:0">
              <div class="uc-section-head">
                ...
                <div style="display:flex;gap:6px">
                  ...
                  <button class="btn-mini btn-warn" onclick="startDropReconnect('${escAttr(key)}', '${escAttr(uuid)}')" id="drop-reconnect-btn" title="Сбросить соединения и проверить сколько IP переподключится">
...
function getSuspects() {
  ...
  // 3. Серверная детекция observed (warning) — НЕ добавляем в подозрительные.
  // Они показываются как "наблюдение" в карточках сессий через isUnderObservation().
    ...
    <div class="ai-settings-grid">
      ...
      <div class="ai-settings-side">
        ...
        <div class="settings-card ai-privacy-card">
          <h4>Приватность</h4>
          <ul>
            <li>Провайдер, модель и API-ключ сохраняются в SQLite-базе панели.</li>
